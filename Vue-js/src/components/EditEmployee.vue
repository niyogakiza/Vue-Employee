        ...
        <form @submit.prevent="updateEmployee" class="col s12">
          <div class="row">
            <div class="input-field col s12">
              <input  disabled placeholder="Employee ID" type="text" v-model="employee_id" required>
            </div>
          ...
          <div class="row">
            <div class="input-field col s12">
              <input placeholder="Department" type="text" v-model="dept" required>
            </div>

          </div>
          <div class="row">
            <div class="input-field col s12">
              <input  placeholder="Position" type="text" v-model="position" required>
            </div>
